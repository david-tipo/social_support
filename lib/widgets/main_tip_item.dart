...
import 'package:social_support/providers/main_problems.dart';

import '../providers/auth.dart';

class MainTipItem extends StatefulWidget {
  final MainTip tip;
  final String problemID;
  bool _isLiked;

  MainTipItem(this.tip, this.problemID, this._isLiked);

  @override
  State<MainTipItem> createState() => _MainTipItemState();
}

class _MainTipItemState extends State<MainTipItem> {
  @override
